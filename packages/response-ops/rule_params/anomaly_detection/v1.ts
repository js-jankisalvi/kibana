...
import { jobsSelectionSchema } from '../common/jobs_selection_schema';

export const mlAnomalyDetectionParamsSchema = schema.object({
...
export type MlAnomalyDetectionRuleParams = TypeOf<typeof mlAnomalyDetectionParamsSchema>;
